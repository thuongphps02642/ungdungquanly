...
Public Class frmQLKhachHang
    ...
    Private Sub frmQLKhachHang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim connect As SqlConnection = New SqlConnection(chuoiconnect) ' Tạo đối tượng kết nối tới Database  Online
        ' Câu truy vấn để get dữ liệu
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("select * from KHACHHANG_PS02642", connect)
        'Kết nối mở ra
        If dgvdanhsachkhachhang.Rows.Count > 0 Then
            'Nếu có dữ liệu thì xóa dữ liệu để load lại tránh bị trùng dữ liệu
            database.Clear()
        End If
        connect.Open()
        ...
        dgvdanhsachkhachhang.DataSource = database.DefaultView
    End Sub
    ...
    Private Sub btntimkiem_Click(sender As Object, e As EventArgs) Handles btntimkiem.Click
        ...
        End If
        ' Câu truy vấn để get dữ liệu
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("Select * from KHACHHANG_PS02642 Where MaKH Like N'%" & txttimkiem.Text & "%' or TenKH Like N'%" & txttimkiem.Text & "%' or SoDT Like N'%" & txttimkiem.Text & "%' or DiaChi Like N'%" & txttimkiem.Text & "%' or SoDT Like N'%" & txttimkiem.Text & "%'", connect)
        Try
            connect.Open()
            Query1.Fill(database)
    ...
    Private Sub dgvdanhsachkhachhang_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvdanhsachkhachhang.CellContentClick
        Dim index As Integer = dgvdanhsachkhachhang.CurrentCell.RowIndex
        txtmakhachhang.Text = dgvdanhsachkhachhang.Item(0, index).Value
        txttenkhachhang.Text = dgvdanhsachkhachhang.Item(1, index).Value
        txtsodt.Text = dgvdanhsachkhachhang.Item(2, index).Value
        txtdiachi.Text = dgvdanhsachkhachhang.Item(3, index).Value
    End Sub
    ...
    Private Sub btnthem_Click(sender As Object, e As EventArgs) Handles btnthem.Click
        ...
        Dim Query2 As String = "insert into KHACHHANG_PS02642 values (@MaKH, @TenKH, @SoDT, @DiaChi)"
        ...
        End Try
        'Refresh bang
        Dim Query3 As SqlDataAdapter = New SqlDataAdapter("select * from KHACHHANG_PS02642", connect)
        database.Clear()
    ...
    Private Sub btnsua_Click(sender As Object, e As EventArgs) Handles btnsua.Click
        ...
        ketnoi1.Open()
        Dim Stradd1 As String = "Update KHACHHANG_PS02642 Set TenKH = @TenKH, SoDT = @SoDT, DiaChi = @DiaChi where MaKH = @MaKH"
        ...
        End Try
        database.Clear()
        dgvdanhsachkhachhang.DataSource = database
    ...
    Private Sub btnxoa_Click(sender As Object, e As EventArgs) Handles btnxoa.Click
        ...
        ketnoi.Open()
        Dim xoadl As String = "Delete from KHACHHANG_PS02642 Where MaKH = @MaKH"
